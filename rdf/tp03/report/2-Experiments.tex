...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth/3]{texture_levels_0.png}
    \includegraphics[width=\textwidth/3]{texture_levels_1.png}
    \includegraphics[width=\textwidth/3]{texture_levels_2.png}
    \includegraphics[width=\textwidth/3]{texture_levels_3.png}
    \includegraphics[width=\textwidth/3]{texture_levels_4.png}
